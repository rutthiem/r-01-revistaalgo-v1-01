...
\input{/home/ruth/.gbpublisher/biblatex/apa-config.tex}
\addbibresource{/home/ruth/00_trabajos/demo01/referencias/ref-r-01-revistaalgo-v1-01.bib}
...
\fancypagestyle{firstpage}{%
  ...
  \fancyhead[L]{%
    ...
    \includegraphics[width=184mm,height=20mm,keepaspectratio=false]{/home/ruth/00_trabajos/demo01/media/logo-revista.png}\\[3mm]%
...
\renewcommand{\articuloautores}{Georgina Berreta Invernizzi}
...
\end{minipage}\par
\vspace{3mm}%
\renewcommand{\articulotitulotrans}{The digital divide and academic performance in higher education: a comparative study in public universities of Argentina and Mexico}
\noindent\begin{minipage}[t]{\dimexpr\textwidth+\marginparsep+\marginparwidth\relax}%
...
{\bfseries\color{azulrevista}Georgina Berreta Invernizzi}\par
, Buenos Aires, Argentina\par
\vspace{6pt}
{\bfseries\color{azulrevista!70}Derechos de autor\'ia:}\par
\textcopyright\ 2026 Berreta Invernizzi, G. Publicado por Blensera. CC BY-NC-ND- 4.0 (\href{http://creativecommons.org/licences/by-nc.nd/4.0}{http://creativecommons.org/licences/by-nc.nd/4.0})\par\vspace{6pt}
...
{\scriptsize\texttt{\href{http://creativecommons.org/licences/by-nc.nd/4.0}{http://creativecommons.org/licences/by-nc.nd/4.0}}}\par
\vspace{6pt}
...
\sffamily\small \textbf{Resumen:} Desigualdad digital y rendimiento académico en la educación superior
...
| **Velocidad de internet \$\textbackslash\{\}ge\$ 20 Mbps** | 23,1\% | 88,2\% | 18,4\% | 86,7\% |
...
Gestión del ancho de banda: Negociar los horarios de uso familiar de internet, tomar clases con la cámara apagada para ahorrar datos o descargar lecturas de madrugada.
Restricciones de pantalla: Quienes dependen exclusivamente de teléfonos móviles reportan serias dificultades para la redacción de trabajos extensos, la consulta simultánea de fuentes y el manejo de gestores bibliográficos, lo que impacta en la calidad de sus entregas.
...
\sffamily\small \textbf{Abstract:} Digital Inequality and Academic Performance in Higher Education
...
The study demonstrates that simply having internet access or a computer does not guarantee academic success. The strongest predictor of academic performance is **digital skills** (\$\textbackslash\{\}beta = 0.34\$), which function as a bridge or mediating variable: students with better material environments develop more complex competencies, which directly translates into better grades and academic progress.
...
| **Internet speed \$\textbackslash\{\}ge\$ 20 Mbps** | 23.1\% | 88.2\% | 18.4\% | 86.7\% |
...
Bandwidth management: Negotiating internet usage times with family members, attending classes with cameras turned off to save data, or downloading reading materials in the early hours of the morning.
Screen restrictions:** Those who rely exclusively on mobile phones report significant difficulties in writing long papers, consulting multiple sources simultaneously, and managing bibliographic tools, which directly impacts the quality of their assignments.
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../media/imagen.png}
\captionof{figure}{imagendescriptiva}
\vspace{\intextsep}
\end{figure}
