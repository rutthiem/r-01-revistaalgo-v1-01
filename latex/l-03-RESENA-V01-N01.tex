...
\renewcommand{\articulotitulo}{A elite do atraso: da escravidão à Lava Jato}
\renewcommand{\articuloautores}{Jessé Souza}
...
\end{minipage}\par
\vspace{3mm}%
\renewcommand{\articulotitulotrans}{The Elite of Backwardness: From Slavery to Operation Car Wash}
\noindent\begin{minipage}[t]{\dimexpr\textwidth+\marginparsep+\marginparwidth\relax}%
...
\textcopyright\ 2026 Souza, J. Publicado por Blensera. Se permite el uso y distribución sin fines comerciales, siempre que se cite la obra original y no se realicen obras derivadas. (\href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{https://creativecommons.org/licenses/by-nc-nd/4.0/})\par\vspace{6pt}
